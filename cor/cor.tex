...
% prof.mean = sort(apply(prof, 2, mean));
...
% plot( prof.mean, 1:length(prof.mean), axes=F, xlab='r', ylab='fraction of probesets', main='CDF of cartilage (triangle) and all probesets (circle) Pearson r' ); box();
% points( know.frag, 1:length(know.frag) * (length(prof.mean)/length(know.frag)), col='red', pch=2 )
