# $Id: Biblio.pm,v 1.13 2005/07/23 12:41:54 senger Exp $
#
...
Retrieve PubMed records in PubMedXML format from NCBI's Eutils access to
Entrez, PubMed, PubMedCentral, and other databases:

   -access => eutils

Retrieve a PDF from a PubMed ID.
...
BEGIN {
    $Revision = q[$Id: Biblio.pm,v 1.13 2005/07/23 12:41:54 senger Exp $];
}
