...
Microarray quantification is the process of estimating the quantity of each gene in the sample that was assayed in the hybridization step (Section \ref{Hybridization}) of the experiment.  It consists of image processing, background correction, normalization, PM correction, and summarization.
